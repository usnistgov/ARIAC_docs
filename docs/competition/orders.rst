...
An order is an instruction containing information on a task (:ref:`KITTING_TASK`, :ref:`ASSEMBLY_TASK`, or :ref:`COMBINED_TASK`). 
...
An example of an order description which consists of a kitting task,
...
This is an example of a combined task. It is similar to the assembly task, except for the field :yamlname:`agv_number` which is not used. 
