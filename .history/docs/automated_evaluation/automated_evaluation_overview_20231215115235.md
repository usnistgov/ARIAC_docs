...
2. In order to enable Nvidia GPU acceleration for the docker container you must install the [Nvidia Container Toolkit](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/install-guide.html#docker). This is not necessary for testing the automated evaluation but is required for the competition. 
