...
12. The output of the trial will be saved in the `~/ariac_ws/src/ariac/automated_evaluation/trials` folder. The output will be saved in a folder named after the trial. The output will include the ROS logs, the output of the evaluation script and the output of the scoring script.